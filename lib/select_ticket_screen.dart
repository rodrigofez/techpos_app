...
class SelectTicketScreen extends StatelessWidget {
  static const routeName = '/select_ticket_screen';

  @override
  Widget build(BuildContext context) {
    Provider.of<Tickets>(context, listen: false).selectedTicketToModify = null;
    final entityName =
...
class SelectTicketScreenBody extends StatelessWidget {
  final entityType;
  final entityName;
  SelectTicketScreenBody({
    this.entityType,
    this.entityName,
  });
...
class TicketsRightPanel extends StatefulWidget {
  ...
  // final ticketsData;
  // TicketsRightPanel({this.ticketsData});
  // const TicketsRightPanel({
  //   Key key,
  // }) : super(key: key);
...
class _TicketsRightPanelState extends State<TicketsRightPanel> {
  ...
  void didChangeDependencies() {
    final dataTickets = Provider.of<Tickets>(context).tempTickets;
    tickets = List.generate(dataTickets.length, (index) {
        ...
        child: ListView(
          ...
          children: [
                      ...
                      children: [
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (ctx, orderIndex) {
                            ...
                            // ticket['data'].orders[orderIndex].tags[iterTags]['quantity']
                            return Column(
            ...
            ExpansionPanelList(
              ...
              expansionCallback: (int index, bool isExpanded) {
                setState(() {
                  tickets[index].update('isExpanded', (value) => !value);
                });
              },
              children: [
                //TICKETS POR AÑADIR
                ...
                //TICKETS YA AÑADIDOS
                ...tickets.map<ExpansionPanel>((ticket) {
                  return ExpansionPanel(
                    canTapOnHeader: true,
                    headerBuilder: (BuildContext context, bool isExpanded) {
                      return ListTile(
                        // tileColor: selectedTicketNumber == ticket['data'].number
                        ...
                        onTap: () {
                          setState(() {
                            ...
                            Provider.of<Tickets>(context, listen: false)
                                .selectedTicketToModify = ticket['data'];
                            Provider.of<Tickets>(context, listen: false)
                              ...
                              Navigator.of(context).popAndPushNamed(
                                ...
                                Scaffold.of(context).showSnackBar(SnackBar(
                                    content: Text(
                                        'No se ha podido abrir el ticket')));
                              });
                            });
                        ...
                        title: Text('TICKET #${ticket['data'].number}'),
                        subtitle: Text((ticket['data'].states as List)
                            .firstWhere((element) =>
                    ...
                    body: Column(
                      children: [
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ListTile(
                              ...
                              subtitle: Text(
                                  '${Provider.of<Tickets>(context).selectedClientsToAdd.where((element) => element['ticketId'] == ticket['data'].id).toList()[index]['clientName'].toString()}'),
                              trailing: IconButton(
                          ...
                          itemCount: Provider.of<Tickets>(context)
                              .selectedClientsToAdd
                              .where((element) =>
                                  element['ticketId'] == ticket['data'].id)
                              .length,
                        ),
                        ListView.builder(
                          primary: false,
                          ...
                          itemBuilder: (context, index) {
                            return ListTile(
                              ...
                              subtitle: Text(
                                  '${Provider.of<Tickets>(context).selectedEntityToChange.where((element) => element['ticketId'] == ticket['data'].id).toList()[index]['entityName'].toString()}'),
                              trailing: IconButton(
                                icon: Icon(Icons.delete),
                                onPressed: () {
                                  Provider.of<Tickets>(context, listen: false)
                        ...
                        ListView.builder(
                          primary: false,
                          shrinkWrap: true,
                          itemCount: ticket['data'].tempOrders != null
                              ? ticket['data'].tempOrders.length
                              : 0,
                          itemBuilder: (ctx, orderIndex) {
                            final orderTotalAmount =
                                ticket['data'].tempOrders[orderIndex]['total'];

                            // ticket['data'].orders[orderIndex].tags[iterTags]['quantity']
                            return Column(
                              key: Key(ticket['data'].tempOrders[orderIndex]
                                  ['date']),
                              children: [
                                Container(
                                  padding: EdgeInsets.symmetric(vertical: 4),
                                                ...
                                                children: [
                                                  ...
                                                  Row(
                                                    children: [
                                                      ...
                                                      Spacer(),
                                                      AutoSizeText(
                                                        "\$${(ticket['data'].tempOrders[orderIndex]['order'].portion['price'] as double).toStringAsFixed(2)}",
                                                        maxLines: 1,
                                                        textAlign:
                                                            TextAlign.left,
                                                        maxFontSize: 12,
                                                  ...
                                                  ListView.builder(
                                                    ...
                                                    itemBuilder:
                                                      ...
                                                      return Row(
                                                        children: [
                                                          AutoSizeText(
                                                            '${(ticket['data'].tempOrders[orderIndex]['order'].tags[iterTags]['quantity']).toInt()} x ${ticket['data'].tempOrders[orderIndex]['order'].tags[iterTags]['tag']}',
                                                            maxFontSize: 12,
                                                            minFontSize: 8,
                                                          ),
                                                          Spacer(),
                                                          AutoSizeText(
                                                            '\$${(ticket['data'].tempOrders[orderIndex]['order'].tags[iterTags]['price'] as double).toStringAsFixed(2)}',
                                                            maxFontSize: 12,
                                                            minFontSize: 8,
                                                          )
                                                        ],
                        ...
                        ListView.builder(
                          primary: false,
                          shrinkWrap: true,
                          itemCount: ticket['data'].orders.length,
                          itemBuilder: (ctx, orderIndex) {
                            final orderTotalAmount = (ticket['data']
                                        .orders[orderIndex]
                                        .tags as List)
                                    .fold(
                                        0,
                                        (previousValue, element) =>
                                            ...
                                            (element['price'] *
                                                element['quantity'])) +
                                (ticket['data'].orders[orderIndex].price *
                                    ticket['data'].orders[orderIndex].quantity);
                            // ticket['data'].orders[orderIndex].tags[iterTags]['quantity']
                            ...
                            if (Provider.of<Tickets>(context)
                                ...
                                .any((element) => element.toString().contains(
                                    ticket['data'].orders[orderIndex].uid))) {
                              ...
                              currentOrderStates =
                                  ticket["data"].orders[orderIndex].states;
                              orderStates =
                                  '${ticket["data"].orders[orderIndex].states.firstWhere((state) => state["stateName"] == "Status")["state"]}' +
                                      '${(ticket["data"].orders[orderIndex].states as List).firstWhere((element) => element['stateName'] == 'GStatus', orElse: () => null) != null ? ', ' + (ticket["data"].orders[orderIndex].states as List).firstWhere((element) => element['stateName'] == 'GStatus')['state'] : ''}';
                            }
                                                ...
                                                children: [
                                                  ...
                                                  Row(
                                                    children: [
                                                      ...
                                                      Spacer(),
                                                      AutoSizeText(
                                                        "\$${(ticket['data'].orders[orderIndex].price as double).toStringAsFixed(2)}",
                                                        maxLines: 1,
                                                        textAlign:
                                                            TextAlign.left,
                                                        maxFontSize: 12,
                                                  ...
                                                  ListView.builder(
                                                    ...
                                                    itemBuilder:
                                                      ...
                                                      return Row(
                                                        children: [
                                                          AutoSizeText(
                                                            '${(ticket['data'].orders[orderIndex].tags[iterTags]['quantity'] as double).toInt()} x ${ticket['data'].orders[orderIndex].tags[iterTags]['tag']}',
                                                            maxFontSize: 12,
                                                            minFontSize: 8,
                                                            style: TextStyle(
                                                              color:
                                                          ...
                                                          Spacer(),
                                                          AutoSizeText(
                                                            '\$${(ticket['data'].orders[orderIndex].tags[iterTags]['price'] as double).toStringAsFixed(2)}',
                                                            maxFontSize: 12,
                                                            minFontSize: 8,
                                                            style: TextStyle(
                                                              color:
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                      '\$${(ticket['data'].totalAmount + ((ticket['data'].tempOrders != null && ticket['data'].tempOrders != []) ? (ticket['data'].tempOrders as List).fold(0, (previousValue, element) => previousValue + element['total']) : 0)).toStringAsFixed(2)}'),
                                ],
                              ),
                            ],
                          ),
